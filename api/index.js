...
export default {
	...
	getVideo: "/notoken/user/get_use_video_url", // 获取小程序视频
	newWxLogin: "/notoken/user/code_to_session", // 微信小程序登录
	userWxLogin: "/notoken/user/customer_login_by_app_client", // 用户微信小程序登录
