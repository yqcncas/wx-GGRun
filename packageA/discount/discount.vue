<template>
	...
	<!-- 	<view class="discount-header">
			<view class="header-left" @tap="goBacktitle">
				<image src="../../static/image/order/left.png" mode="aspectFill"></image>
		...
		<view class="discount-box">
			<view class="discount-item" v-for="(item,index) in disCountList" :key = "index" @tap="goBack(item)" >
				<view class="item-left">
					...
					<image src="../../static/image/order/discount-left.png" mode="aspectFill" class="item-left-jiaobiao"></image>
	...
	.discount{
		...
		.discount-box{
			...
			.discount-item{
				width: 690rpx;
				height: 220rpx;
				background: url(../../static/image/order/discount.png) no-repeat;
